...
export class ReadonlyToken {
   ...
   *
   * During the transition period, checks both {@link ERC7984_WRAPPER_INTERFACE_ID_LEGACY} (legacy,
   * `0xd04584ba`) and {@link ERC7984_WRAPPER_INTERFACE_ID} (post-upgrade, `0x1f1c62b2`)

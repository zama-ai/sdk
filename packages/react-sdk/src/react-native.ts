 ...
 *
 * React Native entry point — excludes browser-only symbols
 * (RelayerWeb, IndexedDBStorage, ChromeSessionStorage).
 *
 * Requires {@link ZamaProvider} in the component tree. Re-exports all public
 * symbols from `@zama-fhe/sdk` that are compatible with React Native.
 *
...
// Re-export core classes (excluding browser-only: RelayerWeb, IndexedDBStorage, ChromeSessionStorage)
export {
  ZamaSDK,
  Token,
  ReadonlyToken,

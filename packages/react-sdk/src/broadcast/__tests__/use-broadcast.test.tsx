...
describe("useBroadcast", () => {
  ...
  test("delegates to sdk.broadcast and returns the receipt", async ({ renderWithProviders }) => {
    ...
    const spy = vi.spyOn(result.current.sdk, "broadcast").mockResolvedValue(TX_RESULT);

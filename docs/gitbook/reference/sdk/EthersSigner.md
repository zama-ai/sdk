...
const signer = new EthersSigner({ signer: wallet }); // [!code focus]
```
...
const signer = new EthersSigner({ provider }); // [!code focus]
```
...
const signer = new EthersSigner({
  ethereum: window.ethereum!, // [!code focus]
});
```

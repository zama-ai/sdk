...
```ts
import { RelayerCleartext, hardhatCleartextConfig } from "@zama-fhe/sdk/cleartext"; // [!code focus]
...
```ts
const relayer = new RelayerCleartext(hardhatCleartextConfig); // [!code focus]
```
...
const relayer = new RelayerCleartext(hoodiCleartextConfig); // [!code focus]
```
...
const myChainConfig: CleartextConfig = {
  ...
  network: "http://localhost:8545", // RPC URL or EIP-1193 provider // [!code focus]
  gatewayChainId: 10901, // Chain ID of the gateway (usually same as Hardhat default) // [!code focus]

  // Contract addresses from your own deployment
  aclContractAddress: "0x...", // ACL contract // [!code focus]
  executorAddress: "0x...", // CleartextFHEVMExecutor — stores plaintext values // [!code focus]

  // EIP-712 verifying contracts (on the gateway chain — usuall same as Hardhat default)
  verifyingContractAddressDecryption: "0x...", // Decryption verifier // [!code focus]
  verifyingContractAddressInputVerification: "0x...", // Input verification // [!code focus]

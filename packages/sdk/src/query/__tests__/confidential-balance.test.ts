...
describe("confidentialBalanceQueryOptions", () => {
  test("uses handle-dependent key and staleTime Infinity", ({ createMockToken }) => {
    const token = createMockToken("0x1a1A1A1A1a1A1A1a1A1a1a1a1a1a1a1A1A1a1a1a");
  ...
  test("enabled is false without handle", ({ createMockToken }) => {
    const token = createMockToken("0x1a1A1A1A1a1A1A1a1A1a1a1a1a1a1a1A1A1a1a1a");
    const options = confidentialBalanceQueryOptions(token, {
      owner: "0x2b2B2B2b2B2b2B2b2B2b2b2b2B2B2b2b2B2b2B2B",
    });
  ...
  test("queryFn reads handle from context.queryKey", async ({ createMockToken }) => {
    const token = createMockToken("0x1a1A1A1A1a1A1A1a1A1a1a1a1a1a1a1A1A1a1a1a");
    const options = confidentialBalanceQueryOptions(token, {
      owner: "0x2b2B2B2b2B2b2B2b2B2b2b2b2B2B2b2b2B2b2B2B",
      handle: "0xaAaAaAaaAaAaAaaAaAAAAAAAAaaaAaAaAaaAaaAaaaaaaaaaaaaaaaaaaaaaaaaa",

...
//@notice Matches the address defined in ZamaConfig.sol for local networks
...
//@notice Can be any address.
address constant inputVerifierAdd = address(0xFF3);

//@notice Can be any address.
address constant hcuLimitAdd = address(0xFF4);

//@notice Can be any address.
address constant pauserSetAdd = address(0xFF5);

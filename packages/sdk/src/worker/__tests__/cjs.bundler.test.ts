...
describe("CJS build smoke tests", () => {
  ...
  test("node worker file exists in ESM output", () => {
...
describe("package.json export conditions", () => {
  ...
  test("files array includes sourcemaps", () => {

...
export const confidentialBalanceQueryKeys: {
  ...
  readonly owner: (
    tokenAddress: string,
    owner: string,
  ) => readonly ["confidentialBalance", string, string];
};
...
export const confidentialBalancesQueryKeys: {
  ...
  readonly tokens: (
    ...
    owner: string,
  ) => readonly ["confidentialBalances", string[], string];
};
...
export const confidentialHandleQueryKeys: {
  ...
  readonly owner: (
    tokenAddress: string,
    owner: string,
  ) => readonly ["confidentialHandle", string, string];
};
...
export const confidentialHandlesQueryKeys: {
  ...
  readonly tokens: (
    tokenAddresses: string[],
    owner: string,
  ) => readonly ["confidentialHandles", string[], string];
};
...
export const confidentialIsApprovedQueryKeys: {
  ...
  readonly spender: (
    tokenAddress: string,
    spender: string,
  ) => readonly ["confidentialIsApproved", string, string];
};
...
export const feeQueryKeys: {
  readonly shieldFee: (
    ...
    from?: string,
    to?: string,
  ) => readonly ["shieldFee", string, ...(string | undefined)[]];
  readonly unshieldFee: (
    feeManagerAddress: string,
    amount?: string,
    from?: string,
    to?: string,
  ) => readonly ["unshieldFee", string, ...(string | undefined)[]];
...
export const underlyingAllowanceQueryKeys: {
  ...
  readonly token: (
    tokenAddress: string,
    wrapper: string,
  ) => readonly ["underlyingAllowance", string, string];
};
...
export function useConfidentialIsApprovedSuspense(
  config: UseConfidentialIsApprovedSuspenseConfig,
...
// @public
export function useCreateDelegatedUserDecryptEIP712(): _tanstack_react_query.UseMutationResult<
  Readonly<{
...
// @public
export function useCreateEIP712(): _tanstack_react_query.UseMutationResult<
  EIP712TypedData,
  Error,
  CreateEIP712Params,
  unknown
...
// @public
export function useDelegatedUserDecrypt(): _tanstack_react_query.UseMutationResult<
...
// @public
export function useEncrypt(): _tanstack_react_query.UseMutationResult<
  EncryptResult,
  Error,
  EncryptParams,
  unknown
...
// @public
export function useGenerateKeypair(): _tanstack_react_query.UseMutationResult<
  FHEKeypair,
  Error,
  void,
  unknown
...
// @public
export function usePublicDecrypt(): _tanstack_react_query.UseMutationResult<
  PublicDecryptResult,
  Error,
  string[],
  unknown
...
export function usePublicParams(
  bits: number,
): _tanstack_react_query.UseQueryResult<PublicParamsResult, Error>;
...
// @public
export function useRequestZKProofVerification(): _tanstack_react_query.UseMutationResult<
  Readonly<{
    handles: Uint8Array[];
...
): _tanstack_react_query.UseMutationResult<TransactionResult, Error, ShieldParams, `0x${string}`>;
...
export function useUnderlyingAllowanceSuspense(
  config: UseUnderlyingAllowanceConfig,
): _tanstack_react_query.UseSuspenseQueryResult<bigint, Error>;
...
): _tanstack_react_query.UseMutationResult<TransactionResult, Error, UnwrapParams, `0x${string}`>;
...
// @public
export function useUserDecrypt(): _tanstack_react_query.UseMutationResult<
  Record<string, bigint>,
  Error,
  UserDecryptParams,
  unknown
...
export const wrapperDiscoveryQueryKeys: {
  ...
  readonly tokenCoordinator: (
    tokenAddress: string,
    coordinatorAddress: string,
  ) => readonly ["wrapperDiscovery", string, string];
};

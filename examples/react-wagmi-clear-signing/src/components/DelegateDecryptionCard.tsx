...
export function DelegateDecryptionCard({
  ...
  const preview = useDelegateDecryptionClearSigningIntent();
  ...
  function handleGrant() {
    delegate.mutate({
      ...
      onClearSigningIntent: (intent) => onIntent?.("runtime", "Grant decryption access", intent),
    });
  }
  ...
  function handlePreview() {
    preview.mutate(
      ...
      {
        onSuccess: (intent) => onIntent?.("preview", "Grant decryption access", intent),
      },
    );
  }
    ...
    <div className="card">
      ...
      <div className="action-row">
        <button
          ...
          disabled={disabled || !canSubmit || preview.isPending}
        >

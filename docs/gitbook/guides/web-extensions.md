...
import {
  ZamaSDK,
  indexedDBStorage,
  chromeSessionStorage, // [!code focus]
} from "@zama-fhe/sdk";
```
...
const sdk = new ZamaSDK({
  relayer,
  signer,
  storage: indexedDBStorage, // encrypted keypair — persistent // [!code focus]
  sessionStorage: chromeSessionStorage, // wallet signature — ephemeral // [!code focus]
});
```

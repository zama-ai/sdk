/**
 * React Native entry point for the Zama fhEVM SDK.
 *
 * Re-exports everything from the main SDK except browser-only symbols:
 * RelayerWeb, IndexedDBStorage, indexedDBStorage, ChromeSessionStorage, chromeSessionStorage.
 *
 * @packageDocumentation
 */

// Core SDK (RelayerWeb excluded — browser-only)
...
export { MemoryStorage, memoryStorage } from "./storage";
export {
  CredentialsManager,

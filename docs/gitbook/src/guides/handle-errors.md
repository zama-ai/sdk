...
| `SignerNotConfiguredError`             | `SIGNER_NOT_CONFIGURED`             | Write/sign/decrypt called without a signer               |
...
| `SignerNotConfiguredError`             | Connect a wallet. The operation requires a signer but the SDK was configured without one.                         |

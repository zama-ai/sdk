...
// Mirror of the on-chain input-handle derivation so the mock input proof the
// cleartext relayer produces is accepted by `CleartextFHEVMExecutor.verifyInput`.

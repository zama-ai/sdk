...
**Network configs:** `SepoliaConfig`, `MainnetConfig`, `HoodiConfig`, `HardhatConfig`.
...
**Errors:** `ZamaError`, `ZamaErrorCode`, `SigningRejectedError`, `SigningFailedError`, `EncryptionFailedError`, `DecryptionFailedError`, `ApprovalFailedError`, `TransactionRevertedError`, `InvalidCredentialsError`, `NoCiphertextError`, `RelayerRequestFailedError`, `ConfigurationError`, `NotSupportedError`, `matchZamaError`.

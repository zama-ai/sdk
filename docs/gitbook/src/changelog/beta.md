...
<!-- TODO: rewrite as plain-language notes -->

_Skeleton of the beta builds since `3.5.1`. The `sdk-changelog` skill rewrites these into the plain-language notes above; this block is regenerated by `pnpm docs:changelog` and dropped when the release is promoted._

### 3.6.0-beta.2 — 2026-09-03

#### Bug Fixes

- **sdk:** structured events + metadata for wallet signing/permit fai… ([#701](https://github.com/zama-ai/sdk/issues/701))

### 3.6.0-beta.1 — 2026-09-02

#### Features

- **sdk:** offload encryption to a web worker in the web() transport ([#683](https://github.com/zama-ai/sdk/issues/683))

### 3.5.2-beta.1 — 2026-08-28

#### Bug Fixes

- self-heal stale pending-unshield pointer ([#645](https://github.com/zama-ai/sdk/issues/645))

<!-- docs:changelog raw-material:end -->
